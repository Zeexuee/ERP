    ...
    public function run(): void
    {
        $materials = [
            [
                ...
                'minimum_stock' => 30,
                'unit_cost' => 250000.00,
                'storage_location' => 'Pabrik Sentul - Rak A-01',
            ],
            [
                'code' => 'MAT-GHR-002',
                ...
                'storage_location' => 'Pabrik Sentul - Brankas Aroma B-01',
            ],
            [
                'code' => 'MAT-GHR-003',
                ...
                'storage_location' => 'Pabrik Sentul - Rak A-02',
            ],
            [
                'code' => 'MAT-GHR-004',
                ...
                'minimum_stock' => 50,
                'unit_cost' => 350000.00,
                'storage_location' => 'Pabrik Sentul - Rak C-01',
            ],
            [
                'code' => 'MAT-GHR-005',
                ...
                'minimum_stock' => 25,
                'unit_cost' => 85000.00,
                'storage_location' => 'Pabrik Sentul - Rak C-02',
            ],
            [
                'code' => 'MAT-GHR-006',
                ...
                'minimum_stock' => 50,
                'unit_cost' => 15000.00,
                'storage_location' => 'Pabrik Sentul - Rak Kemasan D-01',
            ],
            [
                'code' => 'MAT-GHR-007',
                ...
                'minimum_stock' => 30,
                'unit_cost' => 35000.00,
                'storage_location' => 'Pabrik Sentul - Rak Kemasan D-02',
            ],
        ];
        ...
        foreach ($materials as $mat) {
            ...
            MaterialReceipt::create([
                'receipt_number' => 'RCV-'.str_replace('MAT-', '', $mat['code']).'-001',
